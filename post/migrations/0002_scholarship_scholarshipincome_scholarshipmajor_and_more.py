    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scholarship', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='post.scholarship')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('income_range', models.IntegerField(verbose_name='소득분위')),
                ('major_id', models.IntegerField(verbose_name='전공번호')),
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='post.school', verbose_name='학교번호')),
            ],
        ),
        migrations.CreateModel(
